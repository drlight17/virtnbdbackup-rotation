...
# Usage: ./backup_vm.sh <base_path> <vm_name> <keep_months> <recipient_email> <sender_email> [force] [exclude_disk]
# Example: ./backup_vm.sh /backups web01 3 admin@company.com backup@company.com force sda
